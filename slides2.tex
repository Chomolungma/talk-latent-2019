...
\def\research#1{\begin{textblock*}{60mm}(105mm,7.5mm)\centerline{\textcolor{white}{ \footnotesize #1}}\end{textblock*}}
...
\definecolor{gold}{RGB}{249,120,2} % i dunno if this is the same as standard yellow
...
\title[]{Controlling Text Generation
}
\author[]{Alexander Rush / HarvardNLP}
\institute[Harvard NLP]{
  % \begin{center}
...
%   \textbf{Summarization:} Mirella Lapata, Shay Cohen \\
%   \air
%   \textbf{Generation:} Verena Reiser, Mirella Lapata \\
%   \air
%   \textbf{Latent Variable Models:} Ivan Titov, Shay Cohen \\
%   \air
%   \textbf{Translation:} Alexandra Birch, Philip Koehn, Rico Sennrich
% \end{frame}
% \input{intro2.tex}
\input{applications2.tex}
\input{model2.tex}
